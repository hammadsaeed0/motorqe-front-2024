...
const SearchComponents = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        navigate("/garage-dashboard/garagePageWhite", {
          state: { filter: response.data.garages },
        });
  ...
  useEffect(() => {
    ...
    // Initialize Select2 for 'make'
    const makeSelect = $("#select-make");
    makeSelect.select2({
    ...
    // Sync changes from Select2 to React state
    makeSelect.on("change", (e) => {
      handleInputs({ target: { name: "make", value: e.target.value } });
    });
    modelSelect.on("change", (e) => {
      handleInputs({ target: { name: "model", value: e.target.value } });
    });
              ...
              <div className="grid xl:grid-cols-5  w-full lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-9 gap-5">
                <div className="  md:w-48 w-full">
                  ...
                  <select
                    ...
                    name="make"
                    value={state.make}
                    className="mt-1.5 bg-[#FEFBFB] text-gray-600 p-2  border rounded-lg w-full border-[#E9DBDB]"
                  >
                ...
                <div className=" flex gap-2 justify-center pt-2">
                  {advanceFilter === false ? (
                    <p
                      ...
                      className="text-secondary  cursor-pointer border-b  border-secondary  font-semibold"
                    >
                      Advance search
                    </p>
                  ) : (
                ...
                <div className="grid xl:grid-cols-5  w-full lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-9 gap-5">
                  ...
                  <div className="  md:w-48 w-full">
                    ...
                    >
                      ...
                      <option value={"Manual"}>Manual </option>
                      <option value={"Automatic"}>Automatic </option>
                      <option value={"Continuously Variable"}>
