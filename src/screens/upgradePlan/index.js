...
const UpgradePlan = () => {
  ...
  useEffect(() => {
    axios
      .get(`${Base_url}/user/not-enrolled-plan/${id}`)
      .then((res) => {
  ...
  const selectPackage = (item) => {
    ...
    if (!userId) {
      ...
      axios
        .post(`${Base_url}/user/update-plan`, params)
        .then((res) => {
                        ...
                        {item?.name === "Silver" ? (
                          ...
                          <>
                            <li className=" flex gap-2 pt-4">
                              ...
                              <p className=" font-semibold text-sm text-textColor">
                                {item?.refreshBoost} Booster every weeks to
                                refresh your ad whenever during the 45 Days.
                                {/* 5 Days Active Listing */}
                              </p>
                            </li>
                          ...
                          <>
                            <li className=" flex gap-2 pt-4">
                              ...
                              <p className=" font-semibold text-sm text-textColor">
                                {item?.refreshBoost} Booster every 2 weeks to
                                refresh your ad whenever during the 45 Days (One
                                of our members will contact you instantly to
                                take pics & upload them)
                                {/* 5 Days Active Listing */}
                              </p>
                            </li>
