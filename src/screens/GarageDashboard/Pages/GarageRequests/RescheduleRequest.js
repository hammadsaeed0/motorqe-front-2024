...
const RescheduleRequests = ({ isModalOpen, setIsModalOpen, closeModal, getData,setGarageRequest,onClose}) => {
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal} className={""}>
        <div className="">
          <div className="p-3 flex justify-between items-center">
            <h1 className="capitalize font-semibold">Reschedule</h1>
          ...
          <div className="p-5 flex flex-col gap-4">
            ...
            <button
              disabled
              type="button"
              class="mt-4  bg-primary text-white py-2 px-4 rounded hover:bg-secondary"
            >
              <svg
                aria-hidden="true"
                role="status"
